...
- **Innstillinger** — hamburger-meny: UI-språk (norsk, engelsk, tysk, spansk, portugisisk, fransk; første besøk følger telefonen), Wikipedia-kilder (1–3 utgaver) og treff-tak, eksporter/importer og tøm samling, sjekk for app-oppdateringer, og Om appen.
...
- **PWA** — legg til på hjem-skjermen. Rekognoser viser et lite hint i vanlig nettleserfane på telefon. Offline-skallet precaches; appen ber om vedvarende lagring. Nye versjoner lastes inn via «Sjekk for oppdateringer» i Innstillinger. Norsk UI som standard; tysk, spansk, portugisisk og fransk i innstillinger.
